...
#this file is used to compute the path for some predefined global via points.
# and publish it
...
def callback_odom(data):
    ...
    #rospy.loginfo("x:{}, y:{}".format(round(pose[0],2),round(pose[1],2)))
...
def main():
    ...
    pub = rospy.Publisher('/global_path', Path, queue_size=10) #publish path, to visualize in rviz
    pub_speed = rospy.Publisher('/cmd_vel', Twist, queue_size=1)

    #some desired gloabal via points
